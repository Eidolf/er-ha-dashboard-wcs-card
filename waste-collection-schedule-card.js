...
`,_t={en:{"state.today":"Today","state.tomorrow":"Tomorrow","state.in_days":"In {days} days","state.1_day":"In 1 day","state.days":"days","state.day":"day","editor.entity":"Entity (Required)","editor.entities":"Entities (Optional, list)","editor.title":"Title","editor.layout":"Layout Style","editor.layout_card":"Standard Card","editor.layout_row":"Compact Row","editor.layout_grid":"Grid Layout","editor.hide_before":"Hide entire card until X days before (Default: -1 / disabled)","editor.hide_date":"Hide Date Text","editor.hide_days":"Hide Number of Days","editor.hide_dow":"Hide Day of the Week","editor.hide_icon":"Hide Icon","editor.hide_on_click":"Dismiss on click (when due today/tomorrow)","editor.hide_on_today":"Hide on today (e.g. if collected early in morning)","editor.hide_title":"Hide Title","editor.icon_size":"Icon Size (e.g., 30px)","editor.due_color":"Due Today Color (e.g., red or #ff0000)","editor.due_1_color":"Due Tomorrow Color (e.g., orange)","editor.icon_color":"Standard Icon Color (e.g., var(--primary-text-color))","editor.invalid_json":"Invalid JSON format","editor.max_items":"Maximum items to display (Default: 5)","editor.next_only":"Only show the next upcoming collection per waste type","editor.date_format":"Date Format"},de:{"state.today":"Heute","state.tomorrow":"Morgen","state.in_days":"In {days} Tagen","state.1_day":"In 1 Tag","state.days":"Tage","state.day":"Tag","editor.entity":"Entität (Erforderlich)","editor.entities":"Entitäten (Optional, Liste)","editor.title":"Titel","editor.layout":"Layout-Stil","editor.layout_card":"Standard-Karte","editor.layout_row":"Kompakte Zeile","editor.layout_grid":"Raster-Layout (Grid)","editor.hide_before":"Karte ausblenden bis X Tage vor Termin (Standard: -1 / inaktiv)","editor.hide_date":"Datum ausblenden","editor.hide_days":"Tage ausblenden","editor.hide_dow":"Wochentag ausblenden","editor.hide_icon":"Icon ausblenden","editor.hide_on_click":"Per Klick ausblenden (wenn heute/morgen fällig)","editor.hide_on_today":"Heute ausblenden (z.B. bei früher Abholung)","editor.hide_title":"Titel ausblenden","editor.icon_size":"Icon-Größe (z.B. 30px)","editor.due_color":"Farbe am Abholtag (z.B. red oder #ff0000)","editor.due_1_color":"Farbe am Vortag (z.B. orange)","editor.icon_color":"Standard Icon-Farbe (z.B. var(--primary-text-color))","editor.invalid_json":"Ungültiges JSON-Format","editor.max_items":"Maximale Anzahl an Terminen (Standard: 5)","editor.next_only":"Nur den nächsten Termin pro Müllsorte anzeigen","editor.date_format":"Datumsformat"}};function mt(t,e="",i="",s="en"){const o=s.split("-")[0];let n=(_t[o]||_t.en)[t]||_t.en[t]||t;return""!==e&&""!==i&&(n=n.replace(e,i)),n}function yt(t){return t.replace(/Waste Collection Schedule\s*/gi,"").trim()}function bt(t){if(!t)return null;let e=t.match(/(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):(e=t.match(/(\d{2})\.(\d{2})\.(\d{4})/),e?new Date(Number(e[3]),Number(e[2])-1,Number(e[1])):null)}const $t=[{value:"mdi:leaf",label:"Leaf (Bio / Garden)"},{value:"mdi:trash-can",label:"Trash Can (Restmüll)"},{value:"mdi:package-variant",label:"Package (Papier)"},{value:"mdi:recycle",label:"Recycle (Gelber Sack)"},{value:"mdi:glass-fragile",label:"Glass (Glas)"},{value:"mdi:sofa",label:"Sofa (Sperrmüll)"},{value:"mdi:biohazard",label:"Biohazard (Schadstoff)"},{value:"mdi:pine-tree",label:"Pine Tree (Weihnachtsbaum)"},{value:"mdi:trash-can-outline",label:"Default outline"}];let wt=class extends ct{setConfig(t){this._config=t}get _title(){return this._config?.title||""}get _layout(){return this._config?.layout||"card"}get _date_format(){return this._config?.date_format||"DD.MM.YYYY"}get _hide_before(){return this._config?.hide_before??-1}get _due_color(){return this._config?.due_color||"#f44336"}get _due_1_color(){return this._config?.due_1_color||"#ff9800"}get _icon_size(){return this._config?.icon_size||"30px"}get _max_items(){return this._config?.max_items??5}get _next_only(){return!1!==this._config?.next_only}get _entitiesList(){const t=[];this._config?.entity&&t.push(this._config.entity),this._config?.entities&&Array.isArray(this._config.entities)&&t.push(...this._config.entities);const e=[];for(const i of t)""===i?e.push(i):e.includes(i)||e.push(i);return e}_getDetectedWasteTypes(){if(!this.hass||!this._config)return[];const t=new Set,e=this._entitiesList;for(const i of e){const e=this.hass.states[i];if(!e)continue;const s=e.attributes;if(s.wastes&&Array.isArray(s.wastes))for(const e of s.wastes)e.type&&t.add(yt(e.type));for(const[e,i]of Object.entries(s))bt(e)&&t.add(yt(String(i)));const o=yt(s.friendly_name||i.split(".").pop()||"");o&&t.add(o)}return Array.from(t).filter(Boolean)}_getWasteColor(t){const e=this._config?.custom_colors||{};if(e[t])return e[t];const i=t.toLowerCase();return i.includes("bio")||i.includes("organ")||i.includes("braun")||i.includes("garten")?"#4caf50":i.includes("papier")||i.includes("pappe")||i.includes("blau")?"#2196f3":i.includes("gelb")||i.includes("plastik")||i.includes("recycle")||i.includes("wertstoff")?"#fbc02d":i.includes("rest")||i.includes("hausmüll")||i.includes("grau")||i.includes("schwarz")?"#707070":i.includes("glas")||i.includes("flasche")?"#00bcd4":"#e1e1e1"}_getWasteIcon(t){const e=this._config?.custom_icons||{};if(e[t])return e[t];const i=t.toLowerCase();return i.includes("bio")||i.includes("organ")||i.includes("braun")||i.includes("garten")?"mdi:leaf":i.includes("papier")||i.includes("pappe")||i.includes("blau")?"mdi:package-variant":i.includes("gelb")||i.includes("plastik")||i.includes("recycle")||i.includes("wertstoff")?"mdi:recycle":i.includes("rest")||i.includes("hausmüll")||i.includes("grau")||i.includes("schwarz")?"mdi:trash-can":i.includes("glas")||i.includes("flasche")?"mdi:glass-fragile":"mdi:trash-can-outline"}render(){if(!this.hass)return V``;const t=this.hass.language||"en",e=this._getDetectedWasteTypes(),i=this._entitiesList;return V`
      <div class="card-config">
        ...
        <div class="option">
          <ha-select
            .value="${this._layout}"
            .configValue="${"layout"}"
            .options="${[{label:mt("editor.layout_card","","",t),value:"card"},{label:mt("editor.layout_row","","",t),value:"row"},{label:mt("editor.layout_grid","","",t),value:"grid"}]}"
        ...
        <!-- Date Format -->
        <div class="section-title">${mt("editor.date_format","","",t)}</div>
        <div class="option">
          <ha-select
    ...
    `}_renderWasteCustomizerRow(t){const e=this._getWasteIcon(t),i=this._getWasteColor(t),s=!$t.some(t=>t.value===e);return V`
      <div class="waste-row">
        ...
        <div class="waste-inputs">
          ...
          <div class="icon-selector">
            ...
            >
              ${$t.map(t=>V`<option value="${t.value}">${t.label}</option>`)}
    ...
    `}_customStyleChanged(t,e,i){if(this._config){if("color"===e){const e={...this._config.custom_colors||{}};e[t]=i,this._config={...this._config,custom_colors:e}}else if("icon-select"===e){if("custom"!==i){const e={...this._config.custom_icons||{}};e[t]=i,this._config={...this._config,custom_icons:e}}}else if("icon-text"===e){const e={...this._config.custom_icons||{}};e[t]=i,this._config={...this._config,custom_icons:e}}this._fireConfigChanged()}}_entityChanged(t,e){if(!this._config)return;const i=e.detail.value,s=[...this._entitiesList];i?s[t]=i:s.splice(t,1),this._updateEntities(s)}_addEntity(){const t=[...this._entitiesList,""];this._updateEntities(t)}_removeEntity(t){const e=[...this._entitiesList];e.splice(t,1),this._updateEntities(e)}_updateEntities(t){this._config={...this._config,entity:void 0,entities:t.length>0?t:void 0},this._fireConfigChanged()}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.currentTarget||t.target,i=e.configValue||e.getAttribute("configValue");if(i){let s=void 0!==t.detail?.value?t.detail.value:e.value;"max_items"!==i&&"hide_before"!==i||(s=Number(s),isNaN(s)&&(s=void 0)),this._config={...this._config,[i]:s},this._fireConfigChanged()}}_toggleChanged(t){if(!this._config||!this.hass)return;const e=t.currentTarget||t.target,i=e.configValue||e.getAttribute("configValue");i&&(this._config={...this._config,[i]:e.checked},this._fireConfigChanged())}_toggleInvertedChanged(t){if(!this._config||!this.hass)return;const e=t.currentTarget||t.target,i=e.configValue||e.getAttribute("configValue");i&&(this._config={...this._config,[i]:!e.checked},this._fireConfigChanged())}_fireConfigChanged(){const t=new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0});this.dispatchEvent(t)}static{this.styles=a`
    .card-config {
      display: flex;
      flex-direction: column;
      gap: 16px;
  ...
  `}};function vt(t){let e=t.trim();if(e.startsWith("var("))return"244, 67, 54";e=e.replace("#",""),3===e.length&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]);const i=parseInt(e,16);return isNaN(i)?"244, 67, 54":`${i>>16&255}, ${i>>8&255}, ${255&i}`}function xt(t){if(!t)return null;let e=t.match(/(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):(e=t.match(/(\d{2})\.(\d{2})\.(\d{4})/),e?new Date(Number(e[3]),Number(e[2])-1,Number(e[1])):(e=t.match(/(\d{2})\/(\d{2})\/(\d{4})/),e?new Date(Number(e[3]),Number(e[1])-1,Number(e[2])):null))}function At(t,e){const i=String(t.getFullYear()),s=String(t.getMonth()+1).padStart(2,"0"),o=String(t.getDate()).padStart(2,"0");return"YYYY-MM-DD"===e?`${i}-${s}-${o}`:`${o}.${s}.${i}`}function Ct(t,e){const i=new Date(t.getFullYear(),t.getMonth(),t.getDate()),s=new Date(e.getFullYear(),e.getMonth(),e.getDate()),o=i.getTime()-s.getTime();return Math.ceil(o/864e5)}function St(t){return t.replace(/Waste Collection Schedule\s*/gi,"").trim()}t([gt({attribute:!1}),e("design:type",Object)],wt.prototype,"hass",void 0),t([pt(),e("design:type",Object)],wt.prototype,"_config",void 0),wt=t([dt("waste-collection-schedule-card-editor")],wt);let Et=class extends ct{static get styles(){return ft}static getConfigElement(){return document.createElement("waste-collection-schedule-card-editor")}static getStubConfig(){return{entity:"",title:"Müllabfuhr",layout:"card",hide_before:-1}}setConfig(t){if(!t)throw new Error("Invalid configuration");this.config={layout:"card",hide_before:-1,hide_date:!1,hide_days:!1,hide_dow:!0,hide_icon:!1,hide_on_click:!0,hide_on_today:!1,hide_title:!1,due_color:"#f44336",due_1_color:"#ff9800",icon_color:"var(--primary-text-color)",next_only:!0,max_items:5,date_format:"DD.MM.YYYY",...t}}shouldUpdate(t){if(t.has("config"))return!0;const e=t.get("hass");if(e){const t=this._getEntities();for(const i of t)if(e.states[i]!==this.hass.states[i])return!0;return!1}return!0}_getEntities(){const t=[];return this.config.entity&&t.push(this.config.entity),this.config.entities&&Array.isArray(this.config.entities)&&t.push(...this.config.entities),[...new Set(t)]}_getWasteIcon(t){if(this.config.custom_icons){const e=t.toLowerCase();for(const[t,i]of Object.entries(this.config.custom_icons))if(e.includes(t.toLowerCase()))return i}const e=t.toLowerCase();return e.includes("bio")||e.includes("organ")||e.includes("braun")||e.includes("garten")?"mdi:leaf":e.includes("papier")||e.includes("pappe")||e.includes("blau")?"mdi:package-variant":e.includes("gelb")||e.includes("plastik")||e.includes("recycle")||e.includes("wertstoff")?"mdi:recycle":e.includes("rest")||e.includes("hausmüll")||e.includes("grau")||e.includes("schwarz")?"mdi:trash-can":e.includes("glas")||e.includes("flasche")?"mdi:glass-fragile":e.includes("schadstoff")||e.includes("gift")||e.includes("chem")?"mdi:biohazard":e.includes("sperr")?"mdi:sofa":e.includes("tanne")||e.includes("baum")||e.includes("weihnacht")?"mdi:pine-tree":"mdi:trash-can-outline"}_getWasteColor(t){if(this.config.custom_colors){const e=t.toLowerCase();for(const[t,i]of Object.entries(this.config.custom_colors))if(e.includes(t.toLowerCase()))return i}const e=t.toLowerCase();return e.includes("bio")||e.includes("organ")||e.includes("braun")||e.includes("garten")?"#4caf50":e.includes("papier")||e.includes("pappe")||e.includes("blau")?"#2196f3":e.includes("gelb")||e.includes("plastik")||e.includes("recycle")||e.includes("wertstoff")?"#fbc02d":e.includes("rest")||e.includes("hausmüll")||e.includes("grau")||e.includes("schwarz")?"#707070":e.includes("glas")||e.includes("flasche")?"#00bcd4":e.includes("schadstoff")||e.includes("gift")||e.includes("chem")?"#9c27b0":e.includes("sperr")?"#795548":e.includes("tanne")||e.includes("baum")||e.includes("weihnacht")?"#009688":this.config.icon_color||"var(--primary-text-color)"}_parseEntities(){const t=[],e=this._getEntities(),i=new Date;for(const s of e){const e=this.hass.states[s];if(!e)continue;const o=e.attributes,n=St(o.friendly_name||s.split(".").pop()||"Müll");let r=!1;if(o.wastes&&Array.isArray(o.wastes))for(const e of o.wastes){const i=Number(e.daysTo);if(isNaN(i))continue;const o=e.date,a=St(e.type||n),c=0===i,l=1===i,d=`wcs_ack_${s}_${a}_${o}`,h="true"===localStorage.getItem(d),u=xt(o),g=u?At(u,this.config.date_format||"DD.MM.YYYY"):o;t.push({entityId:s,friendlyName:a,daysTo:i,dateText:g,types:[a],icon:this._getWasteIcon(a),color:this._getWasteColor(a),isToday:c,isTomorrow:l,isAcknowledged:h,ackKey:d}),r=!0}for(const[e,n]of Object.entries(o)){const o=xt(e);if(o){const a=Ct(o,i);if(a<0)continue;const c=St(String(n)),l=0===a,d=1===a,h=`wcs_ack_${s}_${c}_${e}`,u="true"===localStorage.getItem(h),g=At(o,this.config.date_format||"DD.MM.YYYY");t.some(t=>t.entityId===s&&t.friendlyName===c&&t.dateText===g)||(t.push({entityId:s,friendlyName:c,daysTo:a,dateText:g,types:[c],icon:this._getWasteIcon(c),color:this._getWasteColor(c),isToday:l,isTomorrow:d,isAcknowledged:u,ackKey:h}),r=!0)}}if(!r){let r=Number(e.state),a=o.dateText||"",c=n;if(isNaN(r)){const t=xt(e.state);t&&(r=Ct(t,i),a=e.state.replace(/^on\s+\w+,\s+/i,""))}if(!isNaN(r)&&r>=0){const e=0===r,i=1===r,o=`wcs_ack_${s}_${c}_${a}`,n="true"===localStorage.getItem(o),l=xt(a),d=l?At(l,this.config.date_format||"DD.MM.YYYY"):a;t.push({entityId:s,friendlyName:c,daysTo:r,dateText:d,types:[c],icon:this._getWasteIcon(c),color:this._getWasteColor(c),isToday:e,isTomorrow:i,isAcknowledged:n,ackKey:o})}}}let s=t.sort((t,e)=>t.daysTo-e.daysTo);if(!1!==this.config.next_only){const t=new Set;s=s.filter(e=>{const i=e.friendlyName.toLowerCase();return!t.has(i)&&(t.add(i),!0)})}const o=Number(this.config.max_items??5);return!isNaN(o)&&o>0&&(s=s.slice(0,o)),s}_acknowledge(t){this.config.hide_on_click&&(t.isToday||t.isTomorrow)&&(localStorage.setItem(t.ackKey,"true"),this.requestUpdate())}render(){if(!this.hass)return null;const t=this._getEntities().filter(Boolean);let e=this._parseEntities();const i=this.config.language||this.hass.language||"en",s=0===t.length;s&&(e=[{entityId:"stub.bio",friendlyName:"Biotonne",daysTo:0,dateText:At(new Date,this.config.date_format||"DD.MM.YYYY"),types:["Bio"],icon:"mdi:leaf",color:"#4caf50",isToday:!0,isTomorrow:!1,isAcknowledged:!1,ackKey:""},{entityId:"stub.paper",friendlyName:"Altpapier",daysTo:1,dateText:At(new Date(Date.now()+864e5),this.config.date_format||"DD.MM.YYYY"),types:["Papier"],icon:"mdi:package-variant",color:"#2196f3",isToday:!1,isTomorrow:!0,isAcknowledged:!1,ackKey:""},{entityId:"stub.rest",friendlyName:"Restmüll",daysTo:5,dateText:At(new Date(Date.now()+432e6),this.config.date_format||"DD.MM.YYYY"),types:["Restmüll"],icon:"mdi:trash-can",color:"#707070",isToday:!1,isTomorrow:!1,isAcknowledged:!1,ackKey:""}]);const o=s?e:e.filter(t=>!t.isAcknowledged&&((!this.config.hide_on_today||!t.isToday)&&!(void 0!==this.config.hide_before&&this.config.hide_before>-1&&t.daysTo>this.config.hide_before)));if(0===o.length)return V``;const n=this.config.due_color||"#f44336",r=this.config.due_1_color||"#ff9800";return V`
      <div 
    ...
    `}_renderItem(t,e){let i="";i=t.isToday?mt("state.today","","",e):t.isTomorrow?mt("state.tomorrow","","",e):1===t.daysTo?mt("state.1_day","","",e):mt("state.in_days","{days}",String(t.daysTo),e);let s=t.color;t.isToday&&this.config.due_color?s=this.config.due_color:t.isTomorrow&&this.config.due_1_color&&(s=this.config.due_1_color);const o=["wcs-item",this.config.layout?`layout-${this.config.layout}`:"",t.isToday?"due-today":"",t.isTomorrow?"due-tomorrow":""].filter(Boolean).join(" ");return V`
      <div 
        class="${o}"
      ...
      >
        ...
        <div class="wcs-content ${this.config.layout?`layout-${this.config.layout}`:""}">
          ...
          >
            ${!this.config.hide_date&&t.dateText?V`<span class="wcs-date">${t.dateText}</span>`:""}
    ...
    `}};t([gt({attribute:!1}),e("design:type",Object)],Et.prototype,"hass",void 0),t([pt(),e("design:type",Object)],Et.prototype,"config",void 0),Et=t([dt("waste-collection-schedule-card")],Et),window.customCards=window.customCards||[],window.customCards.push({type:"waste-collection-schedule-card",name:"Waste Collection Schedule Card",description:"A modern Lovelace card for Home Assistant waste collection schedules.",preview:!0});export{Et as WasteCollectionScheduleCard};
